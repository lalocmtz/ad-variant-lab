    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "user",
            content: `Generate a hyper-realistic 9:16 vertical image for a TikTok ad. The image must look like it was shot on an iPhone with natural lighting. DO NOT include any text overlays in the image.\n\n${prompt}`,
          },
        ],
